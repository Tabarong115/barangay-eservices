...
def _add_enhanced_footer(pdf, request_data, margin):
    ...
    pdf.drawString(PAGE_WIDTH - margin - stringWidth(control, "Helvetica", 7), 22 * mm, control)
    pdf.setFillColor(colors.HexColor("#9CA3AF"))
    pdf.setFont("Helvetica", 6.5)
    pdf.drawCentredString(PAGE_WIDTH / 2, 17 * mm, "QR verification will be added in the next Version 1 step.")
