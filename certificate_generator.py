...
def _add_enhanced_footer(pdf, request_data, margin):
    ...
    if qr_code:
        ...
        # Footer text positioned above QR code to avoid overlap
        pdf.setFillColor(colors.HexColor("#6B7280"))
        pdf.setFont("Helvetica", 7)
        pdf.drawString(margin, 30 * mm, "Generated by Barangay 7 e-Services Portal - Local Pilot")
    else:
        # Fallback if QR code generation fails - center the footer text
        pdf.setFillColor(colors.HexColor("#6B7280"))
        pdf.setFont("Helvetica", 7)
        pdf.drawCentredString(PAGE_WIDTH / 2, 30 * mm, "Generated by Barangay 7 e-Services Portal - Local Pilot")
